...
r18n (http://r18n.rubyforge.org/)). Execute 'flipped/install_libraries.rb' to accomplish this. This will take a minute
or so to automatically download and install the libraries.

On Linux this could take a while longer, since the script will have to compile FXRuby for you (you will need a build
